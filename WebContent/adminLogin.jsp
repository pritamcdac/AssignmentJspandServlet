...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    ...
    <button class="navbar-toggler" type="button" data-bSs-toggle="collapse" data-bs-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
   ...
   <c:set var="message" value="" scope="session"/>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-6">
                <form id="form" action="${pageContext.request.contextPath}/adminLogin" method="post">
